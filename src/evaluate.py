...
def plot_histograms(hlf_class, reference_class, arg):
    ...
    plot_cell_dist(hlf_class, reference_class, arg)
    if arg.dataset[0] == '1':
...
if __name__ == '__main__':
    ...
    # create documenter
    doc = Documenter("not_needed", existing_run=True, basedir=args.output_dir)
    ...
    xml_dir = "/remote/gpu06/ernst/Master_Thesis/vae_calo_challenge/CaloINN/calo_challenge/code"
    xml_filename = f"binning_dataset_{args.dataset.replace('-', '_')}.xml"
