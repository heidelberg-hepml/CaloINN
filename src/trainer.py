...
class Trainer:
    ...
    def __init__(self, params, device, doc):
        ...
        #    data[:,:-3] = train_loader.add_noise(data[:,:-3])
        #else:
    ...
    def generate(self, num_samples, batch_size = 10000, filename='samples.hdf5'):
        """
        ...
        self.model.eval()
        with torch.no_grad():
            energies = torch.rand((num_samples,1))*99 + 1
        ...
        data_util.save_data(
            ...
            data_file = self.doc.get_file(filename)
        )
